...
public class HelloPortfolio {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello, this was printed by servant");
        System.out.println("Servant: Please merge this work to master");
        System.out.println("Servant: Merge testing");
    }
}
//How to:
